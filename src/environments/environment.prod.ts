export const environment = {
  production: true,
  findAllEvents: 'https://bcen-backend.herokuapp.com/event/hosted-events',
  ...
  saveResponsibilities: 'https://bcen-backend.herokuapp.com/responsibility/modified-responsibilities',
